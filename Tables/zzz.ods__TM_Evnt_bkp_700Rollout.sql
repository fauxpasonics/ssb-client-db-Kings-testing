...
[Season_id] [int] NULL,
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Evnt__InsertD__3EFC4F81] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Evnt__UpdateD__3FF073BA] DEFAULT (getdate()),
