CREATE TABLE [apietl].[Appetize_Items_item_group_1]
(
[ETL__Appetize_Items_item_group_id] [uniqueidentifier] NOT NULL,
...
GO
ALTER TABLE [apietl].[Appetize_Items_item_group_1] ADD CONSTRAINT [PK__Appetize__17E9AE6F9C853C98] PRIMARY KEY CLUSTERED  ([ETL__Appetize_Items_item_group_id])
GO
