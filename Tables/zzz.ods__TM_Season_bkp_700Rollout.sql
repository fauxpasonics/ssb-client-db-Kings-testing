...
[org_id] [int] NULL,
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Season__Inser__4C564A9F] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Season__Updat__4D4A6ED8] DEFAULT (getdate()),
