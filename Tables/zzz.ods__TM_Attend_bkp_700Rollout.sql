...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Attend__Inser__1BB31344] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Attend__Updat__1CA7377D] DEFAULT (getdate()),
