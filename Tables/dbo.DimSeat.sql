...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeat__Created__6A1BB7B0] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeat__Updated__6B0FDBE9] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimSeat__IsDelet__6C040022] DEFAULT ((0)),
[DeleteDate] [datetime] NULL CONSTRAINT [DF__DimSeat__DeleteD__6CF8245B] DEFAULT ((0)),
