...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Inser__5026DB83] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Updat__511AFFBC] DEFAULT (getdate()),
