...
[ExtAttribute4_ID] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
...
GO
CREATE NONCLUSTERED INDEX [IX_CompositeAccounts_ExtAttribute4_ID] ON [mdm].[CompositeAccounts] ([ExtAttribute4_ID]) INCLUDE ([ssb_crmsystem_acct_id])
GO
