...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Inser__42CCE065] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Updat__43C1049E] DEFAULT (getdate()),
