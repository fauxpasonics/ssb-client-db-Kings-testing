...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Note__InsertD__5D80D6A1] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Note__UpdateD__5E74FADA] DEFAULT (getdate()),
