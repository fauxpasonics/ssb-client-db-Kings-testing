...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__InsertDa__6BCEF5F8] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__UpdateDa__6CC31A31] DEFAULT (getdate()),
