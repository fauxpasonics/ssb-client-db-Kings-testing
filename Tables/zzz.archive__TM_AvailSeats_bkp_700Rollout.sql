...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Creat__16B953FD] DEFAULT (getdate())
)
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_AvailSeats] ON [zzz].[archive__TM_AvailSeats_bkp_700Rollout] ([event_id])
GO
