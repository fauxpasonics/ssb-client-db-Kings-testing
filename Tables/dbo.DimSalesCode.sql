...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSalesC__Creat__795DFB40] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSalesC__Updat__7A521F79] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimSalesC__IsDel__7B4643B2] DEFAULT ((0)),
