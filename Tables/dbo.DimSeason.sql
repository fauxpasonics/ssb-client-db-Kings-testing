...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Creat__74994623] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Updat__758D6A5C] DEFAULT (getdate()),
[IsDeleted] [bit] NULL CONSTRAINT [DF__DimSeason__IsDel__76818E95] DEFAULT ((0)),
