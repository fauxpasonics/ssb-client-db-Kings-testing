...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_SellLo__Creat__27E3DFFF] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_SellLocation_bkp_700Rollout] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_SellLocation] ON [zzz].[archive__TM_SellLocation_bkp_700Rollout] ([sell_location_id])
GO
