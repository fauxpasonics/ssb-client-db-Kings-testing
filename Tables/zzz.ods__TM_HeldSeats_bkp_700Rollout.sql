...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Inser__4885B9BB] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Updat__4979DDF4] DEFAULT (getdate()),
