...
[OvertimePeriods] [int] NULL CONSTRAINT [DF__DimGameIn__Overt__7C055DC1] DEFAULT ((0)),
[CreatedBy] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedBy] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimGameIn__Creat__7CF981FA] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimGameIn__Updat__7DEDA633] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimGameIn__IsDel__7EE1CA6C] DEFAULT ((0)),
