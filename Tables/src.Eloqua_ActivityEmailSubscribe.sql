...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__373B3228] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__382F5661] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__39237A9A] DEFAULT ((0)),
...
GO
ALTER TABLE [src].[Eloqua_ActivityEmailSubscribe] ADD CONSTRAINT [PK__Eloqua_A__7EF6BFCDCBCD9982] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
