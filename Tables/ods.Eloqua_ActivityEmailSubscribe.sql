...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__25DB9BFC] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__26CFC035] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__27C3E46E] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_ActivityEmailSubscribe] ADD CONSTRAINT [PK__Eloqua_A__3214EC27C9F763F3] PRIMARY KEY CLUSTERED  ([ID])
GO
