...
GO
CREATE NONCLUSTERED INDEX [idx_dimcustomer_sourcesystem_isdeleted_include] ON [dbo].[DimCustomer] ([SourceSystem], [IsDeleted]) INCLUDE ([DimCustomerId], [SSID])
GO
...
GO
CREATE NONCLUSTERED INDEX [NCIX_DimCustomer_UpdatedDate] ON [dbo].[DimCustomer] ([UpdatedDate])
GO
