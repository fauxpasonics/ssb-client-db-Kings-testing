...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__28ED12D1] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__29E1370A] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__2AD55B43] DEFAULT ((0)),
...
GO
ALTER TABLE [src].[Eloqua_ActivityEmailClickThrough] ADD CONSTRAINT [PK__Eloqua_A__7EF6BFCDC7A1B29A] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
