...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Arena__Insert__16EE5E27] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Arena__Update__17E28260] DEFAULT (getdate()),
