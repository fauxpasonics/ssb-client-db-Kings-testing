...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_RetailNonTicket_bkp_700Rollout] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_RetailNonTicket] ON [zzz].[archive__TM_RetailNonTicket_bkp_700Rollout] ([event_name], [section_name])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_RetailNonTicket_bkp_700Rollout] ([SourceFileName])
GO
