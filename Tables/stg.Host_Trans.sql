...
GO
ALTER TABLE [stg].[Host_Trans] ADD CONSTRAINT [PK__Host_Tra__C4EA2445CF0E6A80] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
CREATE NONCLUSTERED INDEX [IDX_SaleDate] ON [stg].[Host_Trans] ([SALEDATE])
GO
CREATE NONCLUSTERED INDEX [IDX_Key] ON [stg].[Host_Trans] ([TM_EVENT_ID], [SEATINFO])
GO
