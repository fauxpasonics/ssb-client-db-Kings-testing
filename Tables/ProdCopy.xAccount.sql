CREATE TABLE [ProdCopy].[xAccount]
(
...
[Archtics_ID__pc] [nvarchar] (40) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[CopyLoadDate] [datetime] NULL CONSTRAINT [DF__Account__CopyLoa__75035A77] DEFAULT (getdate())
)
GO
ALTER TABLE [ProdCopy].[xAccount] ADD CONSTRAINT [PK__Account__3214EC07F45538D1] PRIMARY KEY CLUSTERED  ([Id])
GO
