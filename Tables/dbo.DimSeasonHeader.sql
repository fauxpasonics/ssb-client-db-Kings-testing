...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Creat__6FD49106] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Updat__70C8B53F] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimSeason__IsDel__71BCD978] DEFAULT ((0)),
