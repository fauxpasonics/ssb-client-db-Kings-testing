...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_CustTr__Creat__25083EAB] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_CustTrace_bkp_700Rollout] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_CustTrace] ON [zzz].[archive__TM_CustTrace_bkp_700Rollout] ([seq_id], [acct_id])
GO
