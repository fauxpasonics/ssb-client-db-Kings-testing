...
[retail_acct_add_date] [datetime] NULL,
...
GO
ALTER TABLE [zzz].[ods__TM_Ticket_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Ticke__C4EA2445663D50F5] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
