...
[avs_id] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
ALTER TABLE [ods].[LiveAnalytics_Transaction] ADD CONSTRAINT [PK__LiveAnal__34BC4927FC96D309] PRIMARY KEY CLUSTERED  ([avs_id])
GO
