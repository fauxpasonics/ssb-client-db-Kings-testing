...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Em__ETL_C__39EF184F] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Em__ETL_U__3AE33C88] DEFAULT (getdate()),
...
GO
ALTER TABLE [ods].[Eloqua_EmailGroup] ADD CONSTRAINT [PK__Eloqua_E__3214EC27B85CFBC9] PRIMARY KEY CLUSTERED  ([ID])
GO
