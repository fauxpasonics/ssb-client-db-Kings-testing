...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Creat__1A89E4E1] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_HeldSeats_bkp_700Rollout] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_HeldSeats] ON [zzz].[archive__TM_HeldSeats_bkp_700Rollout] ([event_id])
GO
