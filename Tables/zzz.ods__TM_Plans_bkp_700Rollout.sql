...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Insert__24485945] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Update__253C7D7E] DEFAULT (getdate()),
