...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEvent__Create__08A03ED0] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEvent__Update__09946309] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimEvent__IsDele__0A888742] DEFAULT ((0)),
[DeleteDate] [datetime] NULL,
[IsClosed] [bit] NOT NULL CONSTRAINT [DF__DimEvent__IsClos__0B7CAB7B] DEFAULT ((0)),
