...
[season_id] [int] NULL,
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Events__Inser__375B2DB9] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Events__Updat__384F51F2] DEFAULT (getdate()),
