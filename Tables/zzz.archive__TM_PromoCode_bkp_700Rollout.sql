...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Creat__24134F1B] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_PromoCode_bkp_700Rollout] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_PromoCode] ON [zzz].[archive__TM_PromoCode_bkp_700Rollout] ([promo_code_id])
GO
