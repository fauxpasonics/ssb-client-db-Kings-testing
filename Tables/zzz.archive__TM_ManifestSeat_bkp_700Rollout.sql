...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Creat__1C722D53] DEFAULT (getdate())
)
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_ManifestSeat] ON [zzz].[archive__TM_ManifestSeat_bkp_700Rollout] ([arena_id], [manifest_id])
GO
