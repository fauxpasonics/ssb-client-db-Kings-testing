...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_CustRe__Creat__18A19C6F] DEFAULT (getdate())
)
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_CustRep] ON [zzz].[archive__TM_CustRep_bkp_700Rollout] ([acct_id], [acct_rep_id])
GO
