...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__38EE7070] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__39E294A9] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__3AD6B8E2] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_ActivityWebVisit] ADD CONSTRAINT [PK__Eloqua_A__3214EC27DCDFF599] PRIMARY KEY CLUSTERED  ([ID])
GO
