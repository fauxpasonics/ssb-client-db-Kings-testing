CREATE TABLE [ProdCopy].[xContact]
(
...
[LoadDate] [datetime] NULL CONSTRAINT [DF__Contact__LoadDat__6458BCB9] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IX_pc_cont__1] ON [ProdCopy].[xContact] ([Id])
GO
