...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ca__ETL_C__1394653D] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ca__ETL_U__14888976] DEFAULT (getdate()),
...
GO
ALTER TABLE [ods].[Eloqua_Campaign] ADD CONSTRAINT [PK__Eloqua_C__3214EC271E8BC050] PRIMARY KEY CLUSTERED  ([ID])
GO
