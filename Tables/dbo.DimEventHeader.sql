...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEventH__Creat__5708E33C] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEventH__Updat__57FD0775] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimEventH__IsDel__58F12BAE] DEFAULT ((0)),
