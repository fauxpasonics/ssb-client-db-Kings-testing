...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Inser__2BE97B0D] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Updat__2CDD9F46] DEFAULT (getdate()),
