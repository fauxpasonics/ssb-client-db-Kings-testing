CREATE TABLE [archive].[DimCustomer_bkp_20160321]
(
...
[CompanyName] [nvarchar] (2000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE CLUSTERED INDEX [CIX_Archive_DimCustomer_bkp_20160321] ON [archive].[DimCustomer_bkp_20160321] ([DimCustomerId], [BatchId])
GO
