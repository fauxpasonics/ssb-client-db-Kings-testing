...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__InsertDa__2077C861] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__UpdateDa__216BEC9A] DEFAULT (getdate()),
