...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Season__Creat__25FB978D] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Season_bkp_700Rollout] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Season] ON [zzz].[archive__TM_Season_bkp_700Rollout] ([season_id])
GO
