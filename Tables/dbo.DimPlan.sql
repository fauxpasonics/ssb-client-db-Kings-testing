...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimPlan__Created__48BAC3E5] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimPlan__Updated__49AEE81E] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimPlan__IsDelet__4AA30C57] DEFAULT ((0)),
