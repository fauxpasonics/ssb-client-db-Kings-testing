...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__32767D0B] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__336AA144] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__345EC57D] DEFAULT ((0)),
...
GO
ALTER TABLE [src].[Eloqua_ActivityEmailSend] ADD CONSTRAINT [PK__Eloqua_A__7EF6BFCD79E48F44] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
