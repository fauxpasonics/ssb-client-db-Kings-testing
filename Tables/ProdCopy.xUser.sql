...
[CopyLoadDate] [datetime] NULL CONSTRAINT [DF__User__CopyLoadDa__77DFC722] DEFAULT (getdate())
)
GO
ALTER TABLE [ProdCopy].[xUser] ADD CONSTRAINT [PK__User__3214EC07EE40B246] PRIMARY KEY CLUSTERED  ([Id])
GO
