...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimItem__Created__03DB89B3] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimItem__Updated__04CFADEC] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimItem__IsDelet__05C3D225] DEFAULT ((0)),
