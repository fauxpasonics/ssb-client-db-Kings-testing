...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Attend__Creat__30792600] DEFAULT (getdate())
)
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Attend] ON [zzz].[archive__TM_Attend_bkp_700Rollout] ([acct_id])
GO
