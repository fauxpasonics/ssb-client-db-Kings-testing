...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__4589517F] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__467D75B8] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__477199F1] DEFAULT ((0)),
...
GO
ALTER TABLE [src].[Eloqua_ActivityPageView] ADD CONSTRAINT [PK__Eloqua_A__7EF6BFCD5B4406DC] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
