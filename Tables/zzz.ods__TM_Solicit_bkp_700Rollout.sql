...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Inser__75586032] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Updat__764C846B] DEFAULT (getdate()),
