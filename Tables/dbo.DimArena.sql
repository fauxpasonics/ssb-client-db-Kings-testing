...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimArena__Create__10416098] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimArena__Update__113584D1] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimArena__IsDele__1229A90A] DEFAULT ((0)),
