...
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Class] ON [zzz].[archive__TM_Class_bkp_700Rollout] ([class_id])
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Class_bkp_700Rollout] ([CreatedDate])
GO
