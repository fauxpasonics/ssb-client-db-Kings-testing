...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Inser__61516785] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Updat__62458BBE] DEFAULT (getdate()),
