...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__InsertD__30AE302A] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__UpdateD__31A25463] DEFAULT (getdate()),
