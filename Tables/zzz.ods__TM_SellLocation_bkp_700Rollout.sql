...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_SellLo__Inser__53F76C67] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_SellLo__Updat__54EB90A0] DEFAULT (getdate()),
