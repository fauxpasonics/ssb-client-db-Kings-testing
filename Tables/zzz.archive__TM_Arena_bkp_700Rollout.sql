...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Arena__Create__14D10B8B] DEFAULT (getdate())
)
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Arena] ON [zzz].[archive__TM_Arena_bkp_700Rollout] ([arena_id])
GO
