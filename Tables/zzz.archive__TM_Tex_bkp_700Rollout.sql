...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__CreatedD__2BB470E3] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Tex_bkp_700Rollout] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Tex] ON [zzz].[archive__TM_Tex_bkp_700Rollout] ([event_name], [section_name], [row_name])
GO
