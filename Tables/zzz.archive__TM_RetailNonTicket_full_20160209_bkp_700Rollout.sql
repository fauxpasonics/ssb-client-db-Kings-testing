CREATE TABLE [zzz].[archive__TM_RetailNonTicket_full_20160209_bkp_700Rollout]
(
...
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_RetailNonTicket_full_20160209] ON [zzz].[archive__TM_RetailNonTicket_full_20160209_bkp_700Rollout] ([event_name], [section_name])
GO
