...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Inser__57C7FD4B] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Updat__58BC2184] DEFAULT (getdate()),
