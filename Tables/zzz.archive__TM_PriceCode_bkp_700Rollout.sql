...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Creat__222B06A9] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_PriceCode_bkp_700Rollout] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_PriceCode] ON [zzz].[archive__TM_PriceCode_bkp_700Rollout] ([season_id], [event_id])
GO
