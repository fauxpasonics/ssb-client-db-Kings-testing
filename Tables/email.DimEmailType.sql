...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailT__Creat__15FE9206] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailT__Updat__16F2B63F] DEFAULT (getdate()),
