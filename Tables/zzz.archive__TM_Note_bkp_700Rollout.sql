...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Note__Created__1E5A75C5] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Note_bkp_700Rollout] ([CreatedDate])
GO
CREATE CLUSTERED INDEX [CIX_Archive_TM_Note] ON [zzz].[archive__TM_Note_bkp_700Rollout] ([note_id])
GO
