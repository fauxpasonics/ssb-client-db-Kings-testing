...
CREATE VIEW [segmentation].[vw__Primary_Customer_Information]
AS
    ( SELECT    ssbid.SSB_CRMSYSTEM_CONTACT_ID
              ...
              , CAST(CASE WHEN dimcustomer.PhoneHomeIsCleanStatus = 'Valid' THEN SUBSTRING(dimcustomer.PhoneHome, 2, 3)
                          ELSE NULL
              ...
              , CAST(CASE WHEN dimcustomer.PhoneCellIsCleanStatus = 'Valid' THEN SUBSTRING(dimcustomer.PhoneCell, 2, 3)
                          ELSE NULL
              ...
              , CAST(CASE WHEN dimcustomer.PhoneFaxIsCleanStatus = 'Valid' THEN SUBSTRING(dimcustomer.PhoneFax, 2, 3)
                          ELSE NULL
              ...
              , RIGHT(dimcustomer.EmailPrimary, LEN(dimcustomer.EmailPrimary) - CHARINDEX('@', dimcustomer.EmailPrimary)) Primary_Email_Domain
              ...
              , dimcustomer.EmailOne AS Primary_One
              , RIGHT(dimcustomer.EmailOne, LEN(dimcustomer.EmailOne) - CHARINDEX('@', dimcustomer.EmailOne)) Primary_One_Domain
              ...
              , dimcustomer.EmailTwo AS Primary_Two
              , RIGHT(dimcustomer.EmailTwo, LEN(dimcustomer.EmailTwo) - CHARINDEX('@', dimcustomer.EmailTwo)) Primary_Two_Domain
