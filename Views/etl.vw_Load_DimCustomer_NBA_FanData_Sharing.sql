...
CREATE VIEW [etl].[vw_Load_DimCustomer_NBA_FanData_Sharing] AS 
...
SELECT  'Kings' AS [SourceDB]
      , 'NBA_FanData' AS [SourceSystem]
      , 0 AS [SourceSystemPriority]
      , CAST(a.teampartnersystemcustomerID AS NVARCHAR(50)) AS [SSID]
      ...
      , a.preferredname AS [SalutationName]
      , NULL AS [DonorMailName]
      , NULL AS [DonorFormalName]
      , TRY_CAST(a.dob AS DATE) AS [Birthday]
      , a.gender AS [Gender]
      , 0 [MergedRecordFlag]
      , NULL [MergedIntoSSID]
      ...
      ,a.suffix AS [Suffix]
		...
		/*AddressPrimary*/
      , a.addressline1 AS [AddressPrimaryStreet]
      , a.city AS [AddressPrimaryCity]
      ,a.state AS [AddressPrimaryState]
      , a.zip AS [AddressPrimaryZip]
      , NULL AS [AddressPrimaryCounty]
      , a.country AS [AddressPrimaryCountry]
	  ...
	  , a.addressline2 AS AddressPrimarySuite
      ...
      , NULL AS [PhoneOther]
			...
			/*Email*/
      , a.emailaddress AS [EmailPrimary]
      , NULL AS [EmailOne]
      , NULL AS [EmailTwo]
	...
	/*Source Created and Updated*/
      , NULL [SSCreatedBy]
      , NULL [SSUpdatedBy]
      , a.process_date AS SSCreatedDate
      , NULL [SSUpdatedDate]
...
--		select top 100 *
		FROM  ods.NBA_Fan_Data_Sharing a (NOLOCK)
