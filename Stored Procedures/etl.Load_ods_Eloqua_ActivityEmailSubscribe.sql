...
SELECT CAST(NULL AS BINARY(32)) ETL_DeltaHashKey, ETL_UpdatedDate, ETL_IsDeleted, ETL_DeletedDate, ID, Name, CreatedAt, Type, AssetName, AssetId, AssetType, ContactId, CampaignName, EmailCampaignId, EmailAddress, CampaignId
INTO #SrcData
