...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [etl].[SFDCAccount_Load_DimCustomer_ConversionOnly]
...
-- DROP TABLE #tmpETL
SELECT * INTO #tmpETL FROM etl.[vw_SFDCAccount_Load_DimCustomer_ConversionOnly]
...
THEN UPDATE SET 
	...
	--Possible update to update SFDC records
	UPDATE A SET

	 FullName = ISNULL(b.FullName,a.FullName)
	, Prefix = ISNULL(b.Prefix,a.Prefix)
	, FirstName = ISNULL(b.FirstName,a.FirstName)
	, LastName = ISNULL(b.LastName,a.LastName)
	, NameDirtyHash = ISNULL(b.NameDirtyHash,a.NameDirtyHash)
	...
	, PhonePrimaryDirtyHash = ISNULL(b.PhonePrimaryDirtyHash,a.PhonePrimaryDirtyHash)
	, PhonePrimary = ISNULL(b.PhonePrimary,a.PhonePrimary)

	, EmailPrimaryDirtyHash = ISNULL(b.EmailPrimaryDirtyHash,a.EmailPrimaryDirtyHash)
	, EmailPrimary = ISNULL(b.EmailPrimary,a.EmailPrimary)
	...
	AND a.SourceSystem = 'Kings PC_SFDC Account'
