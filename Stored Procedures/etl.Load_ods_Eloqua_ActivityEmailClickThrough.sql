...
SELECT CAST(NULL AS BINARY(32)) ETL_DeltaHashKey, ETL_UpdatedDate, ETL_IsDeleted, ETL_DeletedDate, ID, Name, CreatedAt, Type, AssetId, AssetName, AssetType, ContactId, EmailClickedThruLink, EmailName, EmailWebLink, SubjectLine, EmailRecipientId, EmailAddress, CampaignId
INTO #SrcData
