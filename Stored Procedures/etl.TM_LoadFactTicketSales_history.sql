...
SELECT tkt.* 
INTO #WorkingSet
FROM ods.TM_vw_Ticket_history tkt
...
SELECT 
	...
	, CASE WHEN dPlan.DimPlanId > 0 THEN (SELECT * FROM dbo.GetQtyFSE(dEvent.DimEventId, dPlan.PlanEventCnt, dSeason.Config_SeasonEventCntFSE, tkt.num_seats)) ELSE 0 END as QtySeatFSE
