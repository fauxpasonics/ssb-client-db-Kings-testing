...
--EXEC [api].[CRM_Ticket_Exchange_Recipient] @SSB_CRMSYSTEM_ACCT_ID = '8EBA10F3-CB88-4E1B-A4DD-3EC97F834345'
--EXEC [api].[CRM_Ticket_Exchange_Recipient] @SSB_CRMSYSTEM_CONTACT_ID = '8EBA10F3-CB88-4E1B-A4DD-3EC97F834345'
...
/*
DECLARE @SSB_CRMSYSTEM_CONTACT_ID VARCHAR(50) = '8EBA10F3-CB88-4E1B-A4DD-3EC97F834345'
...
END
        ...
        SELECT  ssbid.SSB_CRMSYSTEM_CONTACT_ID AS SSB_CRMSYSTEM_CONTACT_ID
			  ...
			  , orgid.FirstName+' '+orgid.LastName AS R_Seller_Name
		INTO #tmpBase
        FROM    ods.TM_Tex Tex
				...
				INNER JOIN Dbo.DimCustomer orgid WITH (NOLOCK) ON orgid.AccountId = Tex.owner_acct_id AND orgid.CustomerType = 'Primary' AND orgid.SourceSystem = 'TM'
...
, ISNULL(R_Seller_Name, '') Seller_Name
INTO #tmpOutput
FROM #tmpBase
