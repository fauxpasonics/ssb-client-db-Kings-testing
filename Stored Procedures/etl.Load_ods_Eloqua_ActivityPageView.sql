...
SELECT CAST(NULL AS BINARY(32)) ETL_DeltaHashKey, ETL_UpdatedDate, ETL_IsDeleted, ETL_DeletedDate, ID, CreatedAt, Type, ContactId, IPAddress, Url, CampaignId, ReferrerUrl, VisitorId, VisitorExternalId, WebVisitId, IsWebTrackingOptedIn
INTO #SrcData
