...
CREATE PROCEDURE [etl].[LoadDimCustomer_Account] 
...
select * 
INTO #SrcData
FROM [ods].[vw_Account_LoadDimCustomer]
...
(
		SourceDB, SourceSystem, SourceSystemPriority, SSID, NameDirtyHash, NameIsCleanStatus, /*CustomerType, CustomerStatus, AccountType, AccountRep, CompanyName, Birthday, Gender, MergedRecordFlag, MergedIntoSSID,*/ Prefix, FirstName, MiddleName, LastName, Suffix,FullName, SSCreatedBy, SSUpdatedBy, SSCreatedDate, SSUpdatedDate, CreatedBy, UpdatedBy, CreatedDate, UpdatedDate
    )
    VALUES (
		mySource.SourceDB
